  ...
  const handleContentClick = (event: MouseEvent) => {
    ...
    try {
      ...
      if (protocol !== "http:" && protocol !== "https:" && protocol !== "mailto:") {
        console.warn("[P1-2] Blocked unsafe assistant link:", href);
        return;
      }
      void open(href).catch((error) => {
        console.error("[P1-2] Failed to open external link:", error);
      });
    } catch {
      console.warn("[P1-2] Blocked malformed assistant link:", href);
    }
  };

  // v0.2-alpha-24 — design 01 layout: assistant messages sit
  ...
  return (
    <div class="message assistant">
      ...
      <div
        ...
        // marked.parse returns sanitised GFM HTML. Assistant content
        // is generated by the agent (a trusted side) but still
        // rendered as innerHTML — see AGENTS.md §security for the
        // threat model.
